...
<div class="container-fluid py-4">
    ...
    <h2 class="mb-4 fw-semibold text-maroon">Daftar Pembayaran</h2>
                                ...
                                <td>
                                    @php
                                        ...
                                        $badgeClass = match ($status) {
                                            ...
                                            'menunggu' => 'bg-info-subtle text-maroon',
...
.bg-info-subtle {
    background-color: #f9ecec !important; /* sedikit merah muda lembut */
}
.bg-danger-subtle {
